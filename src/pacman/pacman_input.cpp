...
// NOTE: Tetris uses JOY_Y < 1200 for Left/Right menu nav, but in Tetris game:
// x = JOY_X. We should be careful about orientation.
// In portrait mode with standard joystick holding:
// Up is Y < 1200, Down is Y > 2800
// Left is X < 1200, Right is X > 2800
